...
//		currentSession.setMaxInactiveInterval(0); // no time out period when value is zero or less than zero
//		currentSession.setMaxInactiveInterval(5*60); //5 minutes and 60 is seconds, so total 300 seconds
